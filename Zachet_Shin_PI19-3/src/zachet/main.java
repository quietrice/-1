/*
Создать класс и его объекты - размеры одежды (XXS, XS, S, M, L).
Создать класс с перечислением объектов. Перечисление содержит метод getDescription, возвращающий строку "Взрослый размер".
...
public class main {
    String[] typeClothes = { tshirt, shirt };
}
